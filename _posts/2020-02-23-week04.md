...
* ### [The Fuck](https://github.com/nvbn/thefuck) ([MIT](https://github.com/nvbn/thefuck/blob/master/LICENSE.md)): Dirty Name, Clean Terminal Commands
  * Excuse the bad language. This is a cool command line tool that helps correct types or incorrect console commands. It is fairly active, with basic but still inviting documents. Since the project is relatively small I can see myself trying to add or fix a bug in a use case for myself. Would fork.
